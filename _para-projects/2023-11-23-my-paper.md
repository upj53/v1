...
```text
어떤 메타인지 전략을 사용했는가?
각각의 영역에 대해서 어떻게 넘어가는가?
진도표, 
과목 소개, 교육 목표, 2022교육과정의 핵심 역량
선행 연구
학생들이 어려워하는 반복문의 영역이다.
학생들이 최종적으로 도달해야 하는 것은 이곳이다.
메타인지 전략이 ...가 있는데 나는 무엇을 사용했다.
!계획, 모니터, 조절, 평가
!각각 잘 반영했는지?
계획은...문제를 푸는 시간을 설정하기
조절과 평가, 모니터링과 평가
메타인지 전략을 어떤걸 사용한거지?
!설문지에 메타인지 전략에 대해 설명하기
ChatGPT
https://chatgpt.com/share/e9133465-f202-4301-817f-3a688fdba962

!메타인지 전략을 개략적으로 찾고 논문 읽기
!선행연구 정리하기
!메타인지 전략에 대한 정리하기
!전문가들에게 무엇을 물어볼지 정리하기
!메타인지 전략 정리하기
!5~6월 메타인지, 설문지 정리하기
!7월 
ADDIE 모형 기반으로 메뉴 설명
